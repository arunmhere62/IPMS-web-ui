...
export function LoginScreen() {
  ...
  return (
    <div className='relative overflow-hidden'>
      ...
      <div className='pointer-events-none absolute top-40 -right-24 h-[420px] w-[420px] rounded-full bg-emerald-500/10 blur-3xl' />
      <div className='pointer-events-none absolute bottom-0 -left-24 h-[420px] w-[420px] rounded-full bg-violet-500/10 blur-3xl' />
        ...
        <div className='mx-auto w-full max-w-md'>
          <Card className='w-full overflow-hidden rounded-3xl border border-primary/10 bg-white/70 shadow-[0_18px_60px_rgba(15,23,42,0.12)] backdrop-blur'>
            <CardHeader>
              ...
              <CardDescription>
                Use your phone number to login with OTP
              </CardDescription>
            </CardHeader>
            <CardContent>
              {phase === 'phone' ? (
